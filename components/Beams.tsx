...
function extendMaterial(
  ...
  BaseMaterial: new (params?: Record<string, unknown>) => any,
  cfg: ExtendMaterialConfig
) {
  const physical = THREE.ShaderLib.physical as unknown as {
    vertexShader: string;
  ...
  Object.entries(cfg.uniforms ?? {}).forEach(([key, u]) => {
    uniforms[key] =
      u !== null && typeof u === "object" && "value" in (u as object) ? u : { value: u };
  });
